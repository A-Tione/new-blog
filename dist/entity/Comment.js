...
var Comment = (_dec = (0, _typeorm.Entity)(), _dec2 = (0, _typeorm.PrimaryGeneratedColumn)('increment'), _dec3 = (0, _typeorm.Column)('text'), _dec4 = (0, _typeorm.ManyToOne)(function (type) {
  return _User.User;
}, function (user) {
  return user.comments;
}), _dec5 = (0, _typeorm.ManyToOne)(function (type) {
  return _Post.Post;
}, function (Post) {
  ...
  writable: true,
  initializer: null
}), _descriptor4 = (0, _applyDecoratedDescriptor2["default"])(_class2.prototype, "post", [_dec5], {
  configurable: true,
  enumerable: true,
  writable: true,
  initializer: null
